...
# spyre-inference currently only supports PF (Physical Function); VF support
# is not implemented. The senlib config tweak below disables RISC-V emulation
# and is only required for VF — skip it under PF.
