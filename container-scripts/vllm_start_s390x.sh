...
# It (re)sources /tmp/etc/ibm/spyre/aiu_env.sh with the host-autogenerated
# multi-card AIU_WORLD_* config and prepends /opt/ibm/spyre/*/lib to
# LD_LIBRARY_PATH. The zz-*.sh scripts in /etc/profile.d/ run after this
# and have the last word on LD_LIBRARY_PATH ordering and (optionally)
